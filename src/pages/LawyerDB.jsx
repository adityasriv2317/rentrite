...
function LawyerDB() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      ...
      // Fetch clients and meetings from local storage or use sample data
  ...
  return (
    <div className="max-w-6xl h-full mx-auto p-6 bg-white shadow-md rounded-lg mt-10">
        ...
        <table className="min-w-full bg-white">
          <thead>
            <tr>
              ...
              <th className="py-2 px-4 border-b-2 border-gray-300">Case</th>
            </tr>
          </thead>
          <tbody>
            {clients.map((client) => (
        ...
        <table className="min-w-full bg-white">
          <thead>
            <tr>
              ...
              <th className="py-2 px-4 border-b-2 border-gray-300">Time</th>
              <th className="py-2 px-4 border-b-2 border-gray-300">Client</th>
          ...
          <tbody>
            {meetings.map((meeting) => (
              <tr key={meeting.id}>
                ...
                <td className="py-2 px-4 border-b border-gray-300">{meeting.topic}</td>
              </tr>
            ))}
          </tbody>
        </table>
